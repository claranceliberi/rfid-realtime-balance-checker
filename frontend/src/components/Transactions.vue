<template>
<div class="transaction-holder  pt-10">
<!--  <div class="card-to-fetch w-2/6">-->
<!--     <h1 class="text-4xl font-black mb-4">CardNumber</h1>-->
...
<!--  </div>-->
  <div class="second-row flex justify-evenly">
<!--  <div class="card">-->
<!--    <div class="card&#45;&#45;front">-->
<!--      <div class="card__number">{{transactions[0].card.card_UUID}}</div>-->
<!--      <div class="card__expiry-date">{{transactions[0].card.balance}} RWF</div>-->
<!--      <div class="card__owner">TAP & SIT</div>-->
...
<!--    </div>-->
<!--  </div>-->
  <div class="table-holder flex justify-center">
    <div class="table">
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="transaction in transactions" :key="transaction.id">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900">{{transaction.transaction_type === 'DEPOSIT' ? '+' : '-'}}{{ transaction.ammount }}</div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
...
.card {
	 font: 10.6666666667px 'Helvetica Neue', Helvetica, sans-serif;
	 position: relative;
